...
async def init_db() -> None:
    ...
    This is the "how to initialize the database tables" step: it runs
    automatically on app startup (see main.py) when AUTO_CREATE_TABLES=true.
    It is equivalent to running, once, against your Render Postgres instance:
